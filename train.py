...
def train_epoch(model, data_iterator, optimizer, scheduler, params, model_type):
...
def train_and_evaluate(model, train_data, val_data, optimizer, scheduler, params, model_dir, model_type):
    ...
    for epoch in range(1, params.epoch_num + 1):
        ...
        train_epoch(model, train_data_iterator, optimizer, scheduler, params, model_type)
        ...
        val_metrics = evaluate(model, val_data_iterator, params, model_type ,mark='Val')
        ...
        if improve_f1 > 1e-5:    
            ...
            torch.save(model.state_dict(), model_dir + '/' + model_type +'.pt')
...
if __name__ == '__main__':
    ...
    # Train and evaluate the model
    logging.info("Training model is {}".format(model_type))
    logging.info("Starting training for {} epoch(s)".format(params.epoch_num))
    train_and_evaluate(model, train_data, val_data, optimizer, scheduler, params, tagger_model_dir, model_type)